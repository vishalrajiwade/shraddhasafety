    ...
    <div className="relative isolate bg-white">
        ...
        <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
          <div className="flex gap-x-4">
            ...
            <dd><a className="hover:text-gray-900" href="mailto:contact@yourcompany.com">contact@shraddhasafetyservices.com</a></dd>
          </div>
          <div className="flex gap-x-4">
            <dt className="flex-none">
            ...
            <dd>2300/15, Sadguru Apartment, Near Manish Complex, Pasthal, Boisar(West), Tal. & Dist. Palghar - 401504</dd>
          </div>
        </dl>
      </div>
    </div>
